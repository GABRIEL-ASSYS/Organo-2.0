# Organo 2.0
  ...
  Organo 2.0 é a continuação do projeto Organo criado durante um curso da plataforma Alura com o objetivo de auxiliar no aprendizado de desenvolvimento WEB utilizando React.js, sendo uma página WEB de organização de times, o foco deste proejto é a adição de algumas features ao projeto original.
...
* Insira https://github.com/GABRIEL-ASSYS/Organo-2.0 no campo URL do Repositório.
